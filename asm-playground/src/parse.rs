use crate::EncodableInstruction;

pub use unasm_derive::Operand;
...
impl Patch {
    ...
    pub(crate) fn into_relative(self) -> Self {
        match self {
...
pub use unasm_derive::ParsableInstruction;
...
pub use unasm_derive::ParsableOpcode;
